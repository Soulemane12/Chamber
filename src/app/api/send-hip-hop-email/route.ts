...
export async function POST(request: Request) {
  try {
    ...
    const userMailOptions = {
      from: `"Midtown Biohack Hip Hop Program" <${DEFAULT_CONTACT_EMAIL}>`,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          ...
          <p style="color: #4b5563; font-size: 16px; line-height: 1.6;">
            <strong>Congratulations honoree of the hip hop museum!</strong> 🎉
          </p>
          ...
          <div style="text-align: center; margin: 30px 0; padding: 20px; background: #f9fafb; border-radius: 8px;">
            ...
            <p style="color: #7c3aed; font-size: 16px; font-weight: 600; margin: 15px 0;">
              Thank you for choosing Midtown Biohack for your wellness journey! 🌟
            </p>
          </div>
